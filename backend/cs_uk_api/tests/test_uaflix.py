...
def test_uaflix_allowlist_includes_ashdi():
    ...
    ashdi serial page must not 502 with `disallowed host`. The
    declaration now lives on the provider class (ADR-0005)."""
    assert "ashdi.vip" in UAFlixProvider.allowed_hosts
